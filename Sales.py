...
class salesClass:
    def __init__(self, root):
        ...
        btn_search=Button(self.root,text="Serach",command=self.search,font=("times new roman",15,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=360,y=100,width=120,height=28)
        ...
        #Image
        menu_logo_path = r"C:\Users\NITESH\images\cat2.jpg"
        self.bill_photo = Image.open(menu_logo_path)
    ...
    def show(self):
       ...
       # print(os.listdir('../IMS')) bill1.txt
